    ...
    <Box sx={{ display: 'flex' }}>
      ...
      >
        ...
        <List className='drawer flex flex-col items-center'>
          ...
          <ListItem className='flex flex-col w-full' >
            <ListItemButton onClick={handleItemClick1} className='flex items-center gap-10 list w-full justify-between'>
            ...
            {expanded1 && (
              <div className='ex mt-4 gap-5 bg300 w-full pl-12 ml-7'>
                {/* Other links or content */}
                <Link className='m-1' to='/transactions'>
                  <p className='text-sm cursor-pointer text-green-500'>All Transactions</p>
                </Link>
                <Link className='m-1' to='/transactions'>
                  <p className='text-sm cursor-pointer text-green-500'>New </p>

                </Link>
                <Link className='m-1' to='/transactions'>
                  <p className='text-sm cursor-pointer text-green-500'>Asigned</p>

                </Link>
                <Link className='m-1' to='/transactions'>
                  <p className='text-sm cursor-pointer text-green-500'>Flocked  Transactions</p>

                </Link>
                <Link className='m-1' to='/transactions'>
                  <p className='text-sm cursor-pointer text-green-500'>Frozen  Transactions</p>
          ...
          <ListItem className='flex flex-col w-full' >
            ...
            {expanded && (
              <div className='ex mt-4  bg300 w-full pl-12 ml-7'>
                ...
                <Link className='m-1' to='/users'>
                  <p className='text-sm cursor-pointer text-green-500'>Verified  Users</p>

                </Link>
                <Link className='m-1' to='/users'>
                  <p className='text-sm cursor-pointer text-green-500'>UnVerified  Users</p>

                </Link>
                <Link className='m-1' to='/users'>
                  <p className='text-sm cursor-pointer text-green-500'>Flocked  Users</p>

                </Link>
                <Link to='/users'>
                  <p className='text-sm cursor-pointer text-green-500'>Frozen  Users</p>
      ...
      <Main open={open}>
        ...
        <Routes >
          ...
          <Route path='/calaculations' element={<Calculations />} />
