  ...
  return (
    <div className='mt-1 w-full flex flex-col items-'>
      ...
      <div className="flex items-center gap-7 flex-wrap">
        <div style={{width:'22%'}} className="flex flex-col border p-2 rounded-lg shadow-2xl pr-2">
      ...
      <div className="flex w-full items-center gap-12 flex-wrap mt-5">
        <div style={{width:'39%'}} className="flex flex-col items- justify-center  border bg-slate-100 shadow-2xl rounded-2xl p-2 h-80">
          <DonutChart />
        </div>
      ...
      <div className="flex items-center mt-8 gap-14 mb-16 flex-wrap">
